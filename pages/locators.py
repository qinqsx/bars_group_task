...
class ProductsPageLocators:
    ...
    SAUCE_LABS_FLEECE_JACKET_ADD_BUTTON_LINK = (
        By.CSS_SELECTOR, "#add-to-cart-sauce-labs-fleece-jacket")
    SAUCE_LABS_FLEECE_JACKET_REMOVE_BUTTON_LINK = (
        By.CSS_SELECTOR, "#remove-sauce-labs-fleece-jacket")
    SAUCE_LABS_BOLT_T_SHIRT_ADD_BUTTON_LINK = (
        By.CSS_SELECTOR, "#add-to-cart-sauce-labs-bolt-t-shirt")
    SAUCE_LABS_BOLT_T_SHIRT_REMOVE_BUTTON_LINK = (
...
class CartPageLocators:
    ...
    INVENTORY_SECOND_ITEM_NAME_LINK = (
